...
const settingsSchema = new mongoose.Schema(
  {
    ...
    mpPublicKey: { type: String, default: '', trim: true },
    mpAccessToken: { type: String, default: '', trim: true },
    mpMode: { type: String, default: 'sandbox', enum: ['sandbox', 'production'] },
    transferEnabled: { type: Boolean, default: true },
    bankHolder: { type: String, default: '', trim: true },
    bankCuit: { type: String, default: '', trim: true },
    bankName: { type: String, default: '', trim: true },
    bankAlias: { type: String, default: '', trim: true },
    bankCbu: { type: String, default: '', trim: true },
    cashEnabled: { type: Boolean, default: false },
    cashInstructions: { type: String, default: 'Coordinar retiro por WhatsApp', trim: true },
    storeName: {
      type: String,
      default: 'PrintLab 3D',
      trim: true
